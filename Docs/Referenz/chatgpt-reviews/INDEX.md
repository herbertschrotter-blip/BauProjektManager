...
| CGR-2026-08-27-bpm-architektur | Gesamtauswertung-Review: ChatGPTs 12-Diagramm-Analyse (Recovery-/Journal-Befunde, Import-Pipeline, Dateibrowser) vs. beschlossener Rahmen ADR-058–061 + BPM-109/111/112/113 | r1–r3 | Runde 3 (Sign-off) offen | ChatGPT-Share „Softwareentwicklungsdiagramme" + Claude-Verifikation (v0.28.120) | r1: T0–T8-Härtungsplan + Selbstkorrekturen (6/9/10 durch ADR-059 überholt). r2: Diagramm-01–09-Nachlieferung (kein übersehener V1-Befund), Undo-Härtung T7 (5 verifizierte ImportUndoService-Probleme), H0-Cutover. Entscheidungen: Alt-Import deaktivieren · Bucket-A skipDuplicate Delete journalisiert/nicht undo-bar · eigener Task „Import-Transaktions-Härtung" H0+T0–T8 (BPM-112 Slice 3 = T1) |
